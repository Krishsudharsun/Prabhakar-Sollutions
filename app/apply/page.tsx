      ...
      <div className="container">
        <div className="mx-auto grid max-w-5xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <ScrollReveal>
            ...
            <p className="mt-4 text-sm font-medium leading-relaxed text-ink dark:text-white/90 sm:text-base">
            ...
            <div className="mt-8 space-y-3">
              <p className="text-xs font-semibold uppercase tracking-wider text-ink dark:text-white/80">
          ...
          <ScrollReveal delay={0.1}>
            <div className="rounded-3xl border border-navy-900/[0.06] bg-white p-6 sm:p-8 dark:border-white/[0.08] dark:bg-white/[0.045]">
              <QualificationForm />
            </div>
          </ScrollReveal>
        </div>
