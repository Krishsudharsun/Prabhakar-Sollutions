...
import { FileText, CheckSquare, BookOpen, Download } from "lucide-react";
...
const resources = [
  { icon: CheckSquare, type: "Checklist", title: "The Operations Audit Checklist", description: "The 24-point checklist we use internally to find hidden bottlenecks." },
