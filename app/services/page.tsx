...
export const metadata: Metadata = {
  ...
  description:
    "Five services designed to remove founder bottlenecks: Business Operations Audit, AI Automation, SOP Documentation, Workflow Automation, and Business Process Systemization.",
            ...
            return (
              <StaggerItem key={service.slug}>
                <Link
                  ...
                  className="group flex h-full flex-col gap-4 rounded-3xl border border-navy-900/[0.06] bg-white p-8 transition-colors hover:border-royal-600/30 dark:border-white/[0.08] dark:bg-white/[0.045]"
                >
                  ...
                  <div className="flex items-center justify-between border-t border-navy-900/[0.06] pt-4 text-sm dark:border-white/[0.08]">
                    <span className="text-ink-gray">Timeline: {service.engagementFeatures[0].title}</span>
