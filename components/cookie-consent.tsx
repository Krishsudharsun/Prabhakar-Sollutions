      ...
      <AnimatePresence>
        {ready && consent === null && (
          <motion.div
            ...
            className="fixed inset-x-4 bottom-4 z-[60] mx-auto max-w-xl rounded-2xl border border-navy-900/10 bg-white p-5 shadow-xl sm:inset-x-auto sm:right-6 dark:border-white/10 dark:bg-surface-dark"
            role="dialog"
