...
export function Footer() {
  return (
    <footer className="border-t border-navy-900/[0.06] bg-white dark:border-white/[0.08] dark:bg-surface-dark">
      <div className="container py-16">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <Link href="/" className="flex items-center gap-2.5 font-heading text-lg font-bold text-ink dark:text-white">
              <Image
                src="/logo-mark.png"
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-navy-900/[0.06] pt-8 text-xs text-ink-gray sm:flex-row dark:border-white/[0.08]">
