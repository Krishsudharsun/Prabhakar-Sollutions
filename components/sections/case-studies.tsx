...
export function CaseStudies() {
  return (
    <section id="case-studies" className="border-t border-navy-900/[0.06] bg-surface py-16 dark:border-white/[0.08] dark:bg-surface-dark">
        ...
        <StaggerGroup className="mt-16 grid gap-6 lg:grid-cols-3">
          {caseStudies.map((cs) => (
            <StaggerItem key={cs.slug}>
              <article className="flex h-full flex-col rounded-2xl border border-navy-900/[0.06] bg-white p-7 dark:border-white/[0.08] dark:bg-white/[0.045]">
                ...
                <div className="mt-6 grid grid-cols-3 gap-2 border-t border-navy-900/[0.06] pt-5 dark:border-white/[0.08]">
                  {cs.results.map((r) => (
                    <div key={r.label}>
