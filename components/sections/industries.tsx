        ...
        <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
          {industries.map(({ icon: Icon, name }, i) => (
            <ScrollReveal key={name} delay={i * 0.04}>
              <div className="flex h-full flex-col items-center gap-3 rounded-2xl border border-navy-900/[0.06] bg-white px-4 py-7 text-center transition-colors hover:border-royal-600/30 dark:border-white/[0.08] dark:bg-white/[0.045]">
