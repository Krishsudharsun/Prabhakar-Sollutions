            ...
            {steps.map((step, i) => (
              <ScrollReveal key={step.number} delay={i * 0.05}>
                <div className="relative flex gap-6 sm:pl-0">
                  <div className="relative z-10 hidden h-12 w-12 shrink-0 items-center justify-center rounded-full border border-navy-900/10 bg-white font-heading text-sm font-bold text-royal-600 sm:flex dark:border-white/10 dark:bg-surface-dark">
                    {step.number}
                  </div>
                  <div className="flex-1 rounded-2xl border border-navy-900/[0.06] bg-white p-6 dark:border-white/[0.08] dark:bg-white/[0.045]">
