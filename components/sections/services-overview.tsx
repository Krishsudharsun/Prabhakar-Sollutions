            ...
            {capabilities.map((cap) => (
              <StaggerItem key={cap.slug}>
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-xl border border-navy-900/[0.06] bg-white px-4 py-3.5 transition-colors hover:border-royal-600/30 dark:border-white/[0.08] dark:bg-white/[0.045]"
                >
