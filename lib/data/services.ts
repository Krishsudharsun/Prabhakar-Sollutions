...
export const services: Service[] = [
  {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        ["ScaleForge audit", "4–8 weeks", "Deep + implemented", "Founders who want it fixed, not just found"],
      ],
    },
    stats: [
  ...
  },
  {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        ["ScaleForge build", "3–6 weeks", "High, tailored", "Founders who want it custom but don't want to hire for it"],
      ],
    },
    stats: [
  ...
  },
  {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        ["ScaleForge documentation", "Validated by testing", "Structured for upkeep", "Teams that need it to actually get used"],
      ],
    },
    stats: [
  ...
  },
  {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        ["ScaleForge build", "Tested & monitored", "Done for you", "Multi-step, business-critical workflows"],
      ],
    },
    stats: [
  ...
  },
  {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        ["ScaleForge systemization", "Whole business, time-boxed", "Fully integrated", "Founders who want the whole system rebuilt once, well"],
      ],
    },
    stats: [
