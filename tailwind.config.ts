  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        surface: {
          DEFAULT: "#F8FAFC",
          // Dark mode now uses a true charcoal/near-black instead of navy,
          // so "dark mode" reads as dark grey/black rather than dark blue.
          dark: "#09090B",
        },
        // Charcoal scale for dark-mode surfaces, borders, and hover states
        // that used to piggyback on the navy scale.
        charcoal: {
          950: "#09090B",
          900: "#111113",
          800: "#1C1C1F",
